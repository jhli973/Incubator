...
GOOGLE_MAPS_API_KEY = raw_input("What is your Googla maps API key: ")
waypoints_file = "optimalroadmap.tsv"
    ...
    if os.path.exists(file_path):
        ...
        for (waypoint1, waypoint2) in combinations(all_waypoints, 2):
            try:
                ...
                # "distance" in mile
                # distance = route["rows"][0]["elements"][0]["distance"]["value"] * 0.000621371
